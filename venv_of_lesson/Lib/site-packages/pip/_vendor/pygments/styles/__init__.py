...
#: Maps styles names to 'submodule::classname'.
STYLE_MAP = {
...
def get_style_by_name(name):
    ...
    try:
        ...
        raise ClassNotFound("Could not find styles module %r" % mod +
                         (builtin and ", though it should be builtin") + ".")
    try:
        return getattr(mod, cls)
    except AttributeError:
        raise ClassNotFound("Could not find styles class %r in styles module." % cls)
